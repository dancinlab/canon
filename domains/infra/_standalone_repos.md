...
|---|---|---|---|
| `climate`, `carbon-capture`, `environment-thermal`, `environmental-protection`, `desal`, `desalination`, `water-treatment`, `geology`, `earthquake-engineering`, `cartography-gis`, `earth-defense`, `hexa-defense` | 🌍 [dancinlab/hexa-earth](https://github.com/dancinlab/hexa-earth) | 2026-05-06 | 12-verb / 4 그룹 (climate + water + geo + defense). hexa-energy cross-link. MIT. |
| `robotics`, `robotics-transport`, `control-automation` | 🤖 [dancinlab/hexa-bot](https://github.com/dancinlab/hexa-bot) | 2026-05-06 | 4-verb robot substrate (+ `life/dog-robot-test` 합류). MIT. |
| `calendar-time-geography` | ⏰ [dancinlab/hexa-time](https://github.com/dancinlab/hexa-time) | 2026-05-06 | `domains/culture/_standalone_repos.md` 의 hexa-time 3-verb 묶음 안에 합류 (`calendar/` verb). |
