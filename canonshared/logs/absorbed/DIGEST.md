...
from the absorbed JSON alone. The original source files at ~/Dev/ready/canon/
...
Action: Copy from ~/Dev/ready/canon/ (originals still exist).
...
Action: Read full BT files from ~/Dev/ready/canon/docs/breakthrough-theorems.md
...
- **86 genuinely missing files** should be recovered from ~/Dev/ready/canon/
