...
> **诚实警示** (raw#10 C3) — 算术恒等式 `σ(6)·φ(6) = 6·τ(6) = 24` 在数学上成立且唯一于 n=6 (Monte Carlo z = 3.06, p = 0.003 相对 n=28 / n=496)。"最优设计由此恒等式导出"这一说法是关于自然系统如何组织的**研究假设**，**而非测量结果**。根据 `LATTICE_POLICY.md` §1.2/§1.3，n=6 格栅是一个组织工具 — 决不能替代真实的数学 / 物理 / 工程极限 (Shannon · Kolmogorov · Bekenstein · c · ℏ · k · Stefan-Boltzmann · Carnot · ASML 通量 · ERCOT 容量 · …)。根据 raw#10 C3，n=6 格栅拟合**禁止**用于外部实体 (TSMC / ASML / NIST / IPCC / CERN / DeepMind / 任何供应商使用其各自发布的不变量)。
...
> · Carnot · ASML 通量 · ERCOT 容量 · …)。根据 raw#10 C3，
...
| 10 | PHYSICAL-LIMIT | mk1 | **HEXA-ROOFTOP-PV-2ND-LIFE-MICROGRID mk1 — 南非锚定地点微电网 (SA bet #1)** | **物理极限锚点遵循 own#32 (非 n=6 强制拟合)**：Shockley-Queisser 1961 PV 上限 33.7% at Eg=1.34 eV (Tiedje 1984 Si 包络；Ruhle 2016 已发表峰值；商业单晶 Si 22% = SQ 峰值的 65% — HEXA-microgrid mk1 板选择设计底线) · NREL TMY3 / SAURAN 2400 kWh/m²/yr SA 约翰内斯堡 26°S 年 GHI (全球前十分位；PR 0.80 → 1920 kWh/kW/yr 据 NREL PVWatts v5) · Wood-Mackenzie 2023 NMC 二次利用退役 EV 电池组残余循环寿命 1500-2500 次循环至 60% SOH @ 80% DoD (75% SOH 起始；10 年日历寿命；Schmalstieg 2014 + Wang 2014 循环寿命模型；终身能量 972 kWh/kWh 标称) · Spotnitz-Franklin 2003 Li-ion 热失控 80°C 正极反应起始 (Bernardi 1985 发热 Q = I²R + IT(dV_oc/dT) + Incropera 2017 自然对流 h=7.5 W/m²/K → 38°C 稳态失控裕度 @ 40°C SA 设计环境温度，配 32 m²/250 kWh 扩展鳍片散热器；1C 峰值占空内部 T 50°C，仍比失控低 30°C) · Esram-Chapman 2007 MPPT 扰动观察 99% 理论 × 96% 逆变器 (SMA Sunny Tripower 50 / Fronius Symo 50 规格) · Cole 1990 LCOE 财务物理学：参考 T2 100 kW PV + 250 kWh 电池 USD 150,000 capex，在 SA 限电混合规避成本电价 0.17 USD/kWh 下 6.7 年简单回收期 (Eskom Megaflex 0.11 × 75% + 柴油发电机 0.35 × 25% 限电份额)；LCOE 0.12 USD/kWh；折现回收期 11 年 @ r=8%。own#2 主恒等式 (σ·φ=n·τ=J₂=24 at n=6) 验证为可分离数学块 (§7 Block A)；微电网设计常数位于 Blocks B-F 作为物理极限值。继承 6 个前置领域 (energy/solar-architecture SQ 上限 + 日射 · energy/battery-architecture NMC 电化学 + 循环寿命 · energy/power-grid 并网逆变器 + 微电网拓扑 + NRS-097-2/NERSA SSEG · energy/thermal-management SA 峰值环境温度被动冷却 · physics/electromagnetism 半导体带隙 · materials/recycling 二次利用 EV 电池组回收 Nissan Leaf / Tesla Model S / BMW i3 退役 70-80% SOH 电池组；BloombergNEF 2024 1 GWh/yr 供应)。4 层部署阶梯 T1 (50 kW + 100 kWh 农村诊所 USD 75k) → T2 (100 kW + 250 kWh 城市诊所/学校 USD 150k) → T3 (250 kW + 500 kWh 区医院/SME USD 350k) → T4 (500 kW + 500 kWh 区域医院 USD 600k)。F-PV2L-MVP-1..5 90 天 MVP 门：F-PV2L-MVP-1 + F-PV2L-MVP-3 + F-PV2L-MVP-5 (2026-09-30 循环寿命 < 1500 / SCR < 70% / 热管理 > 35°C 内部 @ SA 盛夏峰值) + F-PV2L-MVP-2 (2026-10-31 逆变器 MTBF < 10 yr 在 SA 灰尘+热) + F-PV2L-MVP-4 (2026-12-31 NERSA SSEG 批准 > 18 个月)。最难未知遵循 `proposals/south-africa-applied-tech.md` 第 1 行：二次利用循环寿命数据稀缺 (Wood-Mackenzie 2023 行业数据收敛于 2000 循环中位但需 SA-试点验证)。交叉链接：[energy/solar-architecture](../domains/energy/solar-architecture/) · [energy/battery-architecture](../domains/energy/battery-architecture/) · [energy/power-grid](../domains/energy/power-grid/) · [energy/thermal-management](../domains/energy/thermal-management/) · [physics/electromagnetism](../domains/physics/electromagnetism/) · [materials/recycling](../domains/materials/recycling/)。 | [doc](https://github.com/dancinlab/hexa-energy/blob/main/ROOFTOP-PV-2ND-LIFE-MICROGRID.md) |
...
> 1 领域开端 (pets 轴 = 第 12，2026-05-01)。pets 轴在注册时刻意狭窄 — 伴侣动物消费品表面与三个现有轴相交 (life biomedical / materials small-scale / culture behavioral)，作为专用窄带保留以便未来条目 (cat-food / habitat-substrate / dog-toy / aquarium) 可加入而不污染父轴。每个 pets 轴领域遵循与研究论文**相同的 own#15 21 节模板 + own#31 v3.18 lint** — 消费品领域不享有保真度放宽的轨道。

| 🛸 | 闭包 | 版本 | 产品 | 核心 | 链接 |
|:--:|:-------:|:---:|---------|------|------|
| 10 | PHYSICAL-LIMIT | mk1 | **HEXA-CAT-LITTER mk1 — 物理极限重现的伴侣动物卫生材料 (alien-grade 4 → 10 周期)** | **物理极限锚点遵循 own#32 (非 n=6 强制拟合)**：Helmholtz 双电层 κ⁻¹ + ASTM D5890 Grade-A 自由溶胀 (12× 体积 Wyoming Na-bentonite 据 Grim 1968) · Yoon-Nelson 1984 NH3 突破在 clinoptilolite IX 床上 (≥ 22h 沸石级单独，q=1.6 meq/g 据 Coombs 1997) · BET 1938 表面积 + ASTM D4607 碘值 (≥ 1050 mg/g 椰壳活性炭据 Calgon GAC820) · Eigen-Hammes 1963 扩散极限天花板 on 沸石 IX 速率 · Kozeny-Carman 1937 + Darcy 1856 渗透率 (< 180 µg/m³ 尘 @ 6% 含水调节)。own#2 主恒等式 (σ·φ=n·τ=J₂=24 at n=6) 验证为可分离数学块 (§7 Block A)；cat-litter 设计常数位于 Blocks B-F 作为物理极限值。继承 6 个前置领域 (materials/ceramics + concrete-technology + life/agriculture + life/biology-medical + physics/fluid + materials/recycling)。PHYSICAL-LIMIT 等级遵循 raw 69 (文献锚点物理；实验室测量门控 F-CL-MVP-1..4 90 天 falsifier 2026-07-30 / 2026-08-30)；mk2 试验提案位于 `proposals/cat_litter_mk2_trial_2026_05_01.md` (24 户 × 6 月 × 4 阶段推出，约 $8,340 预算)。交叉链接：[materials/ceramics](../domains/materials/ceramics/) · [life/biology-medical](../domains/life/biology-medical/) · [physics/fluid](../domains/physics/fluid/) · [life/agriculture](../domains/life/agriculture/) · [materials/concrete-technology](../domains/materials/concrete-technology/) · [materials/recycling](../domains/materials/recycling/)。 | [doc](https://github.com/dancinlab/hexa-pet/blob/main/CAT-LITTER.md) |
| 13 | PHYSICAL-LIMIT + CIVILIZATION-SCALE | mk2 | **HEXA-CAT-FOOD mk2 — alien-grade 10 → 13+ 天花板突破** | **mk1 alien-10 锚点**：AAFCO 2024 (蛋白 ≥ 26% / taurine ≥ 0.1% / arginine ≥ 1.04% DM) · Atwater 4-9-4 (1900) · Maillard Arrhenius E_a ≈ 100 kJ/mol (Labuza 1985) · 脂质 Arrhenius E_a 60-80 kJ/mol (Frankel 2005) · a_w < 0.6 (Mossel 1975)。**mk2 alien-11 热力学**：Carnot 1824 可逆热泵下限 on 挤压 ~0.021 kWh/kg + Privalov 1979 ΔH 变性 + Donovan 1979 ΔH 糊化 → mk2 0.15 kWh/kg = 4× 低于 Strahm 2013 0.6 kWh/kg；Landauer 1961 kT ln 2 下限 on 288 位出处 ~8e-19 J/kg + Shannon 1948 → mk2 1 J/kg = 1000× 低于 IBM Food Trust 2019 1 kJ/kg。**mk2 alien-12 生物学**：Weindruch 1985 + Kirk 2012 (0.75 跨物种) + Sinclair 2019 NMN 50% 生物利用度 + Shay-Wright 2007 → ≥ 15% 猫寿命延长 @ 15% CR (14 yr → 16.2 yr)；Deusch 2017 + Cani 2017 → 24 株 Shannon H ≥ 4.0 with Akkermansia ≥ 1e8 CFU/g。**mk2 alien-13+ 文明尺度**：IPCC AR6 + Smil 2017 + Poore-Nemecek 2018 → < 500 km 区域采购 83% 运输排放削减；600M+ 宠物猫 Statista 2024 → ~3.6 Mt CO2e/yr 全球 @ 全 mk2 采用；FAO Climate-Smart 2013 60 种食材冗余；CC-BY-4.0 + WSAVA 2011 + FAO Codex 认可路径。own#2 主恒等式保持为可分离 Block A；设计常数位于 Blocks B-L。10 前置领域 (life/biology-medical + agriculture + synbio + fermentation + herbalism + materials/recycling + physics/thermodynamics + cognitive/ai-quality-scale + life/cancer-therapy + physics/electromagnetism)。F-CF-MVP-1..5 (mk1 90 天门 2026-07-30..2026-09-30) + F-CF-MK2-1..5 (mk2 天花板突破门 2027-Q2 / 2027-Q4 / 2028-Q2 / 2031)。raw 91 C3 诚实：本修订为理论分析；实证门控 F-CF-MK2-1..5 + WSAVA/FAO 认可。物理设计遵循 own#32，非 n=6 强制拟合。 | [doc](https://github.com/dancinlab/hexa-pet/blob/main/CAT-FOOD.md) |

<!-- AUTO:FOOTER_pets:START -->
> 领域：[pets/cat-litter/](../domains/pets/cat-litter/) · [pets/cat-food/](../domains/pets/cat-food/) · [pets/dog-food/](../domains/pets/dog-food/) · [pets/cat-toy/](../domains/pets/cat-toy/) · [pets/dog-toy/](../domains/pets/dog-toy/) · pets 轴 2026-05-01 注册 (第 12 轴)。所有 5 个 pets 轴条目持有 own#15 21 节论文模板 + own#31 v3.19 verify-tautology-ban lint + own#33 ai-native-verify-pattern Block A-G 模板。4 个 mk1 PHYSICAL-LIMIT (alien-grade 10) 遵循 own#32 物理设计；cat-food 升级 mk2 PHYSICAL-LIMIT + CIVILIZATION-SCALE (alien-grade 13+) 2026-05-01 遵循 GRADE_RUBRIC_1_TO_10PLUS 双轴评分。非 n=6 强制拟合。前置继承：cat-litter (materials/ceramics + concrete-technology + life/agriculture + biology-medical + physics/fluid + materials/recycling)；cat-food (10 前置 mk2：life/biology-medical + agriculture + synbio + fermentation + herbalism + materials/recycling + physics/thermodynamics + cognitive/ai-quality-scale + life/cancer-therapy + physics/electromagnetism)；dog-food (life/biology-medical + agriculture + synbio + fermentation + herbalism + materials/recycling)；cat-toy (materials/aramid + recycling + fashion-textile + physics/fluid + life/biology-medical + entomology)；dog-toy (materials/aramid + concrete-technology + recycling + life/biology-medical + physics/fluid + materials/fashion-textile)。cat-litter mk2 试验提案位于 `proposals/cat_litter_mk2_trial_2026_05_01.md`。F-CL-MVP-1..4 + F-CF-MVP-1..5 + F-CF-MK2-1..5 + F-DF-MVP-1..5 + F-CT-MVP-1..5 + F-DT-MVP-1..5 = 29 预声明 falsifier 遵循 own#12 (24 mk1 + 5 mk2 天花板突破)。
...
> 5 个领域扇出 (apps 轴 = 第 13，2026-05-01)。apps 轴刻意聚焦于消费软件产品表面 — 消费软件应用与 3 个现有轴 (计算/认知/物理) 相交，作为专用窄带保留以便未来条目 (媒体编辑器/健身教练/无障碍/生产力) 可加入而不污染父轴。每个 apps 轴领域遵循与研究论文相同的 own#15 21 节模板 + own#31 v3.19 lint + own#33 ai-native-verify-pattern Block A-G — 消费软件领域不享有保真度放宽的轨道。轴内动词区分：camera-filter-app APPLIES 滤镜 (实时捕获)；hexa-filter-algebra AUTHORS / COMPILES 滤镜 (引擎层)；hexa-parallel-self GENERATES 替代自我 (slot-machine)；hexa-main-character DIRECTS 电影风格 (流派自动检测 + 9 效果)；hexa-vsco EDITS + LIBRARY + DISCOVER (后捕获专业照片编辑器，VSCO 功能对等 + 7 项物理极限差异化)。

| 🛸 | 闭包 | 版本 | 产品 | 核心 | 链接 |
|:--:|:-------:|:---:|---------|------|------|
| 10 | PHYSICAL-LIMIT | mk1 | **HEXA-CAMERA-FILTER-APP mk1 — 物理极限重现的消费手机相机滤镜** | **物理极限锚点遵循 own#32 (非 n=6 强制拟合)**：实时帧预算 = 1000/60 fps = 16.67 ms (Nyquist 视觉感知 ≥ 24 fps；流畅 UX 目标 = 60 fps；硬移动实时天花板) · NPU 计算预算 = 17.5 TOPS (Apple A17 Pro 35 TOPS 的 50% / Snapdragon 8 Gen 3 45 TOPS 留出 OS + 并发应用余量) · Roofline 模型 (Williams-Waterman-Patterson 2009)：操作强度 50 FLOPs/byte × 51.2 GB/s DRAM → 内存受限天花板 · Airy 衍射极限 (Airy 1835)：θ_min = 1.22 λ/D，移动镜头 f/1.7 @ 555 nm → Airy 半径 ~1.15 µm 匹配 1.0-1.4 µm 像素 pitch (衍射平衡设计) · Poisson 光子散粒噪声 (传感器 SNR 下限)：σ_shot = √N_photons；日光 ~10000 photons/pixel/frame → 40 dB 清洁图像下限 · JPEG 量化 (Wallace 1991 / ISO/IEC 10918-1) qfactor 75-95 走廊，文件大小正比于 pixel_count / qfactor · Rec.2020 宽色域 (≥ 75% CIE 1931) HDR10 支持 · 50 mJ/frame 能量预算 (3 W 相机活跃 × 16.67 ms；4000 mAh 手机 → 4.8 小时活跃续航余量)。own#2 主恒等式验证为可分离 Block A；camera-filter-app 设计常数位于 Blocks B-F。继承 6 个前置领域 (compute/chip-architecture ISP + NPU 硅约束 · cognitive/ai-multimodal 视觉基础模型 · cognitive/ai-inference-cost 实时延迟预算 · cognitive/ai-quality-scale 感知质量保留 · physics/optics Snell + Airy 衍射 · physics/electromagnetism CMOS 光电量子效率)。F-CFA-MVP-1..5 90 天 falsifier 门 2026-08-30 / 2026-09-30 vs iPhone 15 Pro 参考 (延迟 p95 / NPU 利用 / JPEG 大小 / MOS / 每帧能量)。交叉链接：[compute/chip-architecture](../domains/compute/chip-architecture/) · [cognitive/ai-multimodal](../domains/cognitive/ai-multimodal/) · [cognitive/ai-inference-cost](../domains/cognitive/ai-inference-cost/) · [cognitive/ai-quality-scale](../domains/cognitive/ai-quality-scale/) · [physics/optics](../domains/physics/optics/) · [physics/electromagnetism](../domains/physics/electromagnetism/)。 | [doc](https://github.com/dancinlab/hexa-apps/blob/main/CAMERA-FILTER-APP.md) |

<!-- AUTO:FOOTER_apps:START -->
> 领域：[apps/camera-filter-app/](../domains/apps/camera-filter-app/) · [apps/hexa-filter-algebra/](../domains/apps/hexa-filter-algebra/) · [apps/hexa-parallel-self/](../domains/apps/hexa-parallel-self/) · [apps/hexa-main-character/](../domains/apps/hexa-main-character/) · [apps/hexa-vsco/](../domains/apps/hexa-vsco/) · apps 轴 2026-05-01 注册 (第 13 轴)。全部 5 个 mk1 PHYSICAL-LIMIT (alien-grade 10) 遵循 own#32 物理设计，非 n=6 强制拟合；与研究论文相同的 own#15 21 节模板 + own#31 v3.19 lint + own#33 ai-native-verify-pattern Block A-G。轴内动词区分姊妹配对：APPLIES (camera-filter-app) / AUTHORS (hexa-filter-algebra) / GENERATES (hexa-parallel-self) / DIRECTS (hexa-main-character) / EDITS-LIBRARY-DISCOVER (hexa-vsco) — 共享 16.67 ms 实时预算。F-CFA-MVP-1..5 + F-FA-MVP-1..5 + F-PSELF-MVP-1..5 + F-MC-MVP-1..5 + F-VSCO-MVP-1..5 = 25 个预声明 90 天 falsifier 遵循 own#12 vs iPhone 15 Pro / Snapdragon 8 Gen 3 参考硬件 (2026-08-30 / 2026-09-30 截止)。hexa-vsco 是 apps 轴第 5 个领域 — 首个依赖姊妹 apps 领域 (hexa-filter-algebra 引擎层) 并应用 VSCO 完整功能对等 + 7 差异化物理极限框架。未来 apps 领域 (媒体编辑器/健身教练/无障碍/生产力) 遵循相同物理极限锚定模式。
...
| 🛸 | 闭包 | 版本 | 产品 | 核心 | 链接 |
|:--:|:-------:|:---:|---------|------|------|
| 10 | PHYSICAL-LIMIT | mk1 | **HEXA-BIOCHAR-DRYLAND-RESTORATION mk1 — Karoo/Limpopo 入侵生物质转持久土壤碳** | **物理极限锚点遵循 own#32 (非 n=6 强制拟合)**：Antal-Grønli 2003 慢热解炭收率 25-35% 生物质 + 50-65% 生物质 C 保留 (IECR 42:1619) · Lehmann 2007 / Singh 2012 Arrhenius 矿化 E_a 75-120 kJ/mol → 100-1000 yr 土壤驻留 @ 25 °C (GCB 18:2659) · Glaser-Lehmann 2002 CEC 质量平衡混合规则 (BFS 35:219；Liang 2006 SSSAJ 70:1719 terra-preta 6-30 cmol/kg) · Atkinson 2010 植物可用水提升 5-15% 每 10 t/ha (Plant Soil 337:1) · Smith-Bondeau 2014 SOC 汇 ~ 1.5 GtCO2/yr 全球 / SA 份额 ~ 36-50 MtCO2/yr (GCB 20:3270) · Verra VM0044 (2023) ≥ 100 yr + 10% 缓冲 / Puro.earth Biochar v3 (2024) ≥ 1000 yr 持久去除 · Spokas 2010 H/C < 0.4 稳定性指标 · OSHA 29 CFR 1910.1000 CO 50 ppm + HCN 10 ppm 8-hr TWA。own#2 主恒等式 (σ·φ=n·τ=J₂=24 at n=6) 验证为可分离数学块 (§7 Block A)；biochar 设计常数位于 Blocks B-F 作为物理极限值。继承 6 个前置领域 (life/agriculture Karoo 牧场 6-12 ha/LSU Hoffmann 2014 + life/ecology 入侵 Prosopis 30-80 t/ha van Wilgen 2012 + life/herbalism Acacia mearnsii 35-45% 单宁 Pizzi 1994 + materials/recycling 废物流 EBC II + physics/thermodynamics Antal-Grønli + Arrhenius + materials/concrete-technology Gupta 2018 1-5% 水泥替代)。堆叠 Working-for-Water 清除 USD 20-50/ha (DEFF 2023) + 10-25% 承载力提升 + Verra/Puro USD 80-150/tCO2e × ~ 2.4 tCO2e/t biochar = USD 240-450/t 营收 vs USD 200-400/t 生产成本。PHYSICAL-LIMIT 等级遵循 raw 69 (文献锚点物理 + 农学 + 碳核算；试点窑 + 5-yr 土壤驻留 + N=10 农场对门控 F-BIOCHAR-MVP-1..5 90 天 falsifier 2026-09-30 / 2026-12-31 / 2027-03-31 / 2027-06-30)。最难未知遵循 `proposals/south-africa-applied-tech.md` 第 5 行：自愿碳市场完整性持久 (Verra 完整性丑闻 2023-2024)。交叉链接：[life/agriculture](../domains/life/agriculture/) · [life/ecology](../domains/life/ecology/) · [life/herbalism](../domains/life/herbalism/) · [materials/recycling](../domains/materials/recycling/) · [physics/thermodynamics](../domains/physics/thermodynamics/) · [materials/concrete-technology](../domains/materials/concrete-technology/)。 | [doc](https://github.com/dancinlab/hexa-bio/blob/main/BIOCHAR-DRYLAND-RESTORATION.md) |

### Life 轴 SA 应用技术 bet #2 (alien-grade 10 PHYSICAL-LIMIT)

| 🛸 | 闭包 | 版本 | 产品 | 核心 | 链接 |
|:--:|:-------:|:---:|---------|------|------|
| 10 | PHYSICAL-LIMIT | mk1 | **HEXA-CRISPR-CAS13-POC-DIAGNOSTIC mk1 — 现场可部署 TB/HIV 核酸诊断** | **物理极限锚点遵循 own#32 (非 n=6 强制拟合)**：Abudayyeh-Zhang 2017 (Nature 550:280) Cas13a trans-cleavage k_cat 30-50 /s/molecule on poly-U 底物 · Eigen-Hammes 1963 通用扩散极限天花板 k_cat/K_M ≤ 10⁹ M⁻¹s⁻¹ (碳酸酐酶级极限；Cas13 位于约 1.7 个数量级以下) · Mason-Botella 2020 (Anal. Chem. 92:14644) 冻干 RPA + Cas13 trehalose 5% + mannitol 2% Arrhenius E_a ≈ 80 kJ/mol → 12 mo @ 25 °C / 60% RH (消除 4 °C 冷链) · Posthuma-Trumpie 2009 (Anal. Bioanal. Chem. 393:569) lateral-flow Au-NP 视觉 LOD ~ 10 fM 分析物 / ~ 10⁵ copies 病毒 RNA · Piepenburg-Armes 2006 (PLOS Biol. 4:e204) RPA 等温预扩增 10⁹ amplicons in 20 min at 37-42 °C · Mie 1908 + Haiss 2007 40-nm Au-NP λ_max = 520 nm (可见裸眼读出)。own#2 主恒等式 (σ·φ=n·τ=J₂=24 at n=6) 验证为可分离数学块 (§7 Block A)；诊断设计常数位于 Blocks B-F 作为物理极限值。继承 6 个前置领域 (life/biology-medical Mtb IS6110 多拷贝 10-15/cell Thierry 1990 + HIV-1 RNA 动力学 + life/synbio LbuCas13a 重组 Slaymaker 2019 + life/genetics 28-nt crRNA spacer East-Seletsky 2016 + RPA 引物设计 + life/hiv-treatment WHO 2021 1,000 cp/mL 病毒失败阈值 + materials/ceramics Whatman FF120HP 硝酸纤维素毛细 30 s/cm + physics/optics Mie 1908 / Haiss 2007 Au-NP plasmon 520 nm)。目标世界第 3 TB 负担 450,000 cases/yr 南非 (WHO Global TB Report 2023) + 13% HIV 流行率 8.2M PLHIV (UNAIDS 2023) @ 30-60 min TTR + USD 2-5/test + USD 200-500 reader vs 当前 GeneXpert MTB/RIF 实验室 NAAT 90 min + USD 10-15/cartridge + USD 17,000 仪器 + 4 °C 冷链。PHYSICAL-LIMIT 等级遵循 raw 69 (文献锚点酶动力学 + Arrhenius 货架寿命 + LFA 视觉 LOD 物理；实验室批 + N≥500 配对临床队列 + SAHPRA Class C IVD 预提交门控 F-CAS13-MVP-1..5 falsifier 2026-09-30 / 2026-10-31 / 2026-12-31 / 2027-03-31)。最难未知遵循 `proposals/south-africa-applied-tech.md` 第 2 行：冻干试剂在现场湿度 60-90% RH 下的货架寿命 (门控 F-CAS13-MVP-1 ICH Q1A R2 加速 40 °C × 1 mo Arrhenius 外推至 25 °C / 60% RH 基线)。交叉链接：[life/biology-medical](../domains/life/biology-medical/) · [life/synbio](../domains/life/synbio/) · [life/genetics](../domains/life/genetics/) · [life/hiv-treatment](../domains/life/hiv-treatment/) · [materials/ceramics](../domains/materials/ceramics/) · [physics/optics](../domains/physics/optics/)。 | [doc](https://github.com/dancinlab/hexa-bio/blob/main/CRISPR-CAS13-POC-DIAGNOSTIC.md) |

### Cognitive 轴 SA 应用技术 bet #4 (alien-grade 10 PHYSICAL-LIMIT)

| 🛸 | 闭包 | 版本 | 产品 | 核心 | 链接 |
|:--:|:-------:|:---:|---------|------|------|
| 10 | PHYSICAL-LIMIT | mk1 | **HEXA-YOUTH-AI-LABELING-RLHF-HUB mk1 — 开普敦/约翰内斯堡/德班高端 AI 训练数据 + RLHF hub** | **物理极限锚点遵循 own#32 (非 n=6 强制拟合)**：Cohen 1960 标注员间一致性 kappa = (p_o - p_e) / (1 - p_e) — 专家 >= 0.80 (Landis-Koch 1977 几乎完美下限 0.81) / 多语 >= 0.70 (实质下限 0.61) 遵循 Biometrics 33:159 · Bai-Anthropic 2022 Constitutional AI RLHF 数据效率 (arXiv:2212.08073) — 50k 偏好对足以用于生产级对齐；mk1 吞吐 1k 对/天在 50 天内交付 50k < 90 天 MVP 门；Christiano 2017 (NeurIPS) 10k 窄任务下限 + Ouyang 2022 InstructGPT 33k 通用；SA 工资套利 USD 5-15/对 vs 美国资深 USD 10-30/对 (50% 削减) · Mielke 2019 (ACL) Zipf 低资源扩展 — Zulu/Xhosa 语音语料库 < 100h vs 英语 100,000h+ → 50-100x 数据稀缺溢价遵循 Joshi 2020 (ACL) · Shannon 1948 信息论标注位下限 — H = -sum p log_2 p；最小位/K 类消歧 = log_2 K；专家任务 6-10 位/样本 (K=64-1024)；RLHF 偏好 50-150 位/对包括 Shannon 1951 1.0 位/字符理由 · SAT-3 + WACS 海底电缆开普敦-法兰克福 RTT ~150ms (TeleGeography 2024) — 足以异步队列标注；8 hr/day EU/UK 重叠 vs 2 hr 美东 · Eskom 2024 EAF ~54% (Eskom Annual Report FY2024) — PV 100 kWp DC + LFP 768 kWh 电池 12-hr 自治需用 200 座 64 kW 持续负载 (ASHRAE 90.1 + NFPA 855)。own#2 主恒等式 (σ·φ=n·τ=J₂=24 at n=6) 验证为可分离数学块 (§7 Block A)；hub 设计常数位于 Blocks B-F 作为物理极限值。继承 6 个前置领域 (cognitive/ai-multimodal 多模态标注类型学 + cognitive/ai-quality-scale Cohen 1960 kappa + cognitive/ai-eval-pipeline Bai 2022 CAI 50k 对生产级 + cognitive/ai-alignment Christiano 2017 + Ouyang 2022 + Bai 2022 + cognitive/cognitive-social-psychology Sweller 1988 认知负荷 + Ericsson 1993 刻意练习 4-hr 天花板 + energy/power-grid Eskom EAF + PV+电池；交叉链接 rooftop-pv-2nd-life-microgrid SA 组合姊妹)。11 种 SA 官方语言队列 (Zulu 13M / Xhosa 8M / Afrikaans 7M / Sotho 4M / Tswana 4M / Tsonga / Venda / Ndebele / SiSwati / 英语 / Portuguese 长尾遵循 StatsSA Census 2022)。200 座 hub 235 编制 (Tier-1 专家 20% USD 1,500-2,500/mo + Tier-2 多语 40% USD 800-1,400/mo + Tier-3 通用/RLHF 40% USD 600-1,000/mo + QA 1:10 + leads + HR)。每座单位经济：USD 2-4k capex + USD 600-1,200/mo opex vs USD 1,200-3,500/mo 营收 → 50-65% 毛利通过 SA 工资套利 + 8-hr EU/UK 重叠 + 低资源 Zipf 稀缺溢价。F-RLHF-MVP-1..5 90 天 + 1 年 falsifier 门：F-MVP-1 + F-MVP-5 (2026-09-30 专家工资溢价 < USD 1,000/mo / Eskom 限电 > 8 hr/day 未覆盖) + F-MVP-2 + F-MVP-4 (2026-12-31 多语 kappa < 0.7 / SA YES 税收优惠到期未资助) + F-MVP-3 (2027-03-31 第 1 年客户流失 > 30%)。最难未知遵循 `proposals/south-africa-applied-tech.md` 第 4 行：专家长尾工资溢价持久 vs 标注商品化 (商品 bbox 价格战 USD 0.05-0.20/task vs 高端层 USD 5-50/task)。交叉链接：[cognitive/ai-multimodal](../domains/cognitive/ai-multimodal/) · [cognitive/ai-quality-scale](../domains/cognitive/ai-quality-scale/) · [cognitive/ai-eval-pipeline](../domains/cognitive/ai-eval-pipeline/) · [cognitive/ai-alignment](../domains/cognitive/ai-alignment/) · [cognitive/cognitive-social-psychology](../domains/cognitive/cognitive-social-psychology/) · [energy/power-grid](../domains/energy/power-grid/)。 | [doc](https://github.com/dancinlab/hexa-mind/blob/main/YOUTH-AI-LABELING-RLHF-HUB.md) |
